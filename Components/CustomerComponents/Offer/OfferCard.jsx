...
const OfferCard = ({ title, description, imageUrl }) => {
    return (
      ...
      />
        ...
        <p className="font-serif font-bold text-xl text-gray-600"><span className="text-lg md:text-xl lg:text-2xl leading-12 text-red-500 font-extrabold">10%</span> Off</p>
        </div>
        </div>
            ...
            <div className="block">
              ...
              <div className="font-serif border border-dashed bg-emerald-50 py-2 border-emerald-300 rounded-lg text-center block">
                <button className="block w-full">
                  <span className="uppercase font-serif font-semibold text-base leading-7 text-emerald-600">OCTOBER21</span>
                </button>
              </div>
            </div>
            <p className="text-xs leading-5 text-gray-500 mt-2">
             "* This coupon code will apply on "
              <span className="font-bold text-gray-700">"grocery" "type products"</span>
