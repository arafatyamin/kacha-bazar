      ...
      <section className="p-2">
        <div className="flex justify-between p-6">
          <button className="bg-green-500 p-2 rounded text-white font-bold">
            Download Invoice <AiOutlineCloudDownload className="inline ml-1"></AiOutlineCloudDownload>
          </button>
          <button className="bg-green-500 p-2 rounded text-white font-bold">
            Print Invoice <AiOutlinePrinter className="inline ml-1"></AiOutlinePrinter>
          </button>
        </div>
      </section>
    </div>
