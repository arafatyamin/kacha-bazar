            ...
            <div className="w-full bg-white shadow-sm lg:px-10 lg:py-5 p-6 rounded-lg">
              <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-4">
                <div className="lg:w-full">
                  ...
                  <h2 className="font-sans text-lg lg:text-2xl font-bold mb-1">
                    Quick Delivery to
                  ...
                  <a
                    href=""
                    className="lg:w-25% text-xs font-sans font-medium inline-block mt-5 px-8 py-3 bg-emerald-500 text-center text-white rounded-full hover:text-white hover:bg-emerald-600"
                  >
                    Download App
                  </a>
                </div>
