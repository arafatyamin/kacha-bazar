            ...
            >
                <div className=" min-h-screen relative">
                                ...
                                <div className="flex py-3 px-4" >
                                    ...
                                    <div className="flex items-center justify-between flex-grow">
                                        ...
                                        <div className="flex items-center content-center my-auto  py-0 rounded-md border border-gray-100 font-semibold" >
                                            <div className="m-0">
                                                <button disabled={count < 2 ? true : false} onClick={() => setCount(count - 1)} className=" px-3 py-1 my-0 mx-auto text-lg " >−</button>
                                            </div>
                                            <div className="m-0">
                                                <p className=" px-3 py-1 my-0 mx-auto ">{count}</p>
                                            </div>
                                            <div className="m-0">
                                                <button onClick={() => setCount(count + 1)} className=" px-3 py-1 my-0 mx-auto text-lg " >+</button>
                                            </div>
                                        </div>
                    ...
                    <div className="flex items-center justify-between p-[10px] mx-5 my-3 bg-primary rounded-lg absolute bottom-0 left-0 right-0 ">
                        ...
                        <p className="py-1 px-2 bg-white text-lg rounded-lg text-green-600 font-semibold">$19:00</p>
                    </div>
                </div>
            </Drawer>
        </>
