                    ...
                    <div className="xl:w-1/3">
                        ...
                        <div className="max-w-[500px] mx-auto">
                            <Carousel
                                ...
                                leftArrow={
                                    <MdArrowBackIos
                                        className="relative inset-y-1/2 text-2xl cursor-pointer hover:scale-110 duration-200"/>
                                }
                                rightArrow={
                                    <MdArrowForwardIos
                                        className="relative inset-y-1/2 text-2xl cursor-pointer hover:scale-105 duration-200"/>
                                }
                                useArrowKeys={true}
                            >
                    ...
                    <div className="md:flex xl:w-2/3 ">
                        ...
                        <div className="p-2">
                            ...
                            {stock ? (
                                ...
                                <span
                                    className="mb-3 text-sm bg-red-200 inline-block px-3 py-1 rounded-full text-gray-primary">
                  Out Of Stock
                </span>
                            )}
