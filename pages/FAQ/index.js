...
function faq() {
  ...
  const faqdata = [
    {
      ques: "how does kacha bazar work?",
      ans: "kazakhstan is a online the green vegetables buying and selling websites,We collect the fresh fruits and vegetables from the farmers and fieldand we distribute in to the customer within two to three days.",
    },
    {
      ques: "Whice payment method you should accept?",
      ans: "kazakhstan is a online the green vegetables buying and selling websites,We collect the fresh fruits and vegetables from the farmers and fieldand we distribute in to the customer within two to three days.",
    },
    {
  ...
  //     border: 'none',
  //     backgroundColor: `${isActive === idx && "green" }`
  // };
          ...
          <div className="container">
            <div className="md:flex justify-between">
              <div className=" basis-1/2 ">
                <svg
                  className="h-40 md:h-full max-w-full"
                ...
                >
                  <circle cx="431.39281" cy="548" r="46" fill="#34d399" />
                  <path
