      ...
      <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
        <div className="grid grid-flow-row lg:grid-cols-2 gap-4 lg:gap-16 items-center">
          ...
          <div className="mt-10 lg:mt-0">
                <span>
                  <img src="https://kachabazar-store.vercel.app/_next/image?url=%2Fabout-us.jpg&w=1080&q=75" alt="" />
                </span>
            </div>
        </div>
    ...
    <div className="max-w-screen-2xl mx-auto px-3 sm:px-10">
        <div className="relative flex flex-col sm:flex-row sm:items-end justify-between mb-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 md:mt-3 font-normal block text-base">We’re impartial and independent, and every day we create distinctive, world-class reintermediate backend supply programmes.</p>
          </div>
        </div>
        <div className="grid sm:grid-cols-2 gap-x-5 gap-y-8 lg:grid-cols-6 xl:gap-x-8">
            ...
            <div className="max-w-sm">
              <span>
                <img src="https://kachabazar-store.vercel.app/_next/image?url=%2Fteam%2Fteam-6.jpg&w=640&q=75" alt="" />
              </span>
              <div className="py-4">
