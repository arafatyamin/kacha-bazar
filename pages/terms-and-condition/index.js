            ...
            <div className="py-16">
              <div>
                ...
                <p className="mb-3">
                  ...
                  for the use of KachaBazar's Website, located at
                  https://kachabazar.com/. By accessing this website we assume
              ...
              <div className="mt-3">
                <h2 className="mb-2 text-2xl font-medium">Cookies</h2>
                <p>
                  We employ the use of cookies. By accessing KachaBazar, you
                  agreed to use cookies in agreement with the KachaBazar's
                  ...
                  areas to make it easier for people visiting our website. Some
                  of our affiliate/advertising partners may also use cookies.
                </p>
              </div>
              <div className="mt-3">
                <h2 className="mb-2 text-2xl font-medium">License</h2>
                <p className="mb-3">
                  Unless otherwise stated, KachaBazar and/or its licensors own
                  the intellectual property rights for all material on
                  KachaBazar. All intellectual property rights are reserved. You
                  may access this from KachaBazar for your own personal use
                  subjected to restrictions set in these terms and
                  conditions.This Agreement shall begin on the date hereof. Our
                  Terms and Conditions were created with the help of the Terms
                ...
                <p>
                  ...
                  permitted by applicable laws, KachaBazar shall not be liable
              ...
              <div className="mt-3">
                <h2 className="mb-2 text-2xl font-medium">Content Liability</h2>
                <p className="mb-3">
              ...
              <div className="mt-3">
                <h2 className="mb-2 text-2xl font-medium">Disclaimer</h2>
                <p className="mb-2">
